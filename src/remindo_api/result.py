...
class RemindoResult:
    ...
    def subscription_id(self):
        ...
        return self._result_dict["subscription_id"]

    @property
    def user_id(self):
        """Return the Remindo user id id for the result"""
        return self._result_dict["user_id"]

    @property
    def user_code(self):
        """Return the Remindo user code for the result"""
        return self._result_dict["user_code"]

    @property
    def cluster_ids(self):
        """Return the Remindo cluster ids for the result"""
        return self._result_dict["cluster_ids"]
    ...
    def grade_formatted(self):
        ...
        return self._result_dict["grade_formatted"]

    @property
    def can_change(self):
        """Return the Remindo can change bool for the result"""
        return self._result_dict["can_change"]
